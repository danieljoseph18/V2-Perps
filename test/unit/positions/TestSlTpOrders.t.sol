...
//         positionManager.executePosition{value: 0.0001 ether}(market, tradeStorage.getOrderAtIndex(0, false), OWNER);
//         vm.stopPrank();
...
//         vm.startPrank(OWNER);
//         positionManager.executePosition{value: 0.0001 ether}(market, slKey, OWNER);
//         vm.stopPrank();
...
//         // Update the price data
//         vm.startPrank(OWNER);
//         positionManager.executePosition{value: 0.0001 ether}(market, tpKey, OWNER);
//         vm.stopPrank();
