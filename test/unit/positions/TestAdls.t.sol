...
//         positionManager.executePosition{value: 0.0001 ether}(market, orderKey, USER);
//         orderKey = tradeStorage.getOrderAtIndex(0, false);
//         positionManager.executePosition{value: 0.0001 ether}(market, orderKey, RANDOM1);
//         orderKey = tradeStorage.getOrderAtIndex(0, false);
//         positionManager.executePosition{value: 0.0001 ether}(market, orderKey, RANDOM2);
//         orderKey = tradeStorage.getOrderAtIndex(0, false);
//         positionManager.executePosition{value: 0.0001 ether}(market, orderKey, RANDOM3);

//         vm.warp(block.timestamp + 10);
//         vm.roll(block.number + 1);
//         // move the price so the pnl to pool ratio is lage
//         // here
//         // get one of the position keys
//         bytes32[] memory positionKeys = tradeStorage.getOpenPositionKeys(false);
//         // adl it
//         vm.prank(OWNER);
//         positionManager.executeAdl{value: 0.01 ether}(market, ethAssetId, 5000e30, positionKeys[0]);
