...
//     function whitelistToken(address _token, uint256 _tokenWeight) external onlyAdmin {
//         whitelistedTokens[_token] = true;
//         tokens.push(_token);
//         tokenWeights[_token] = _tokenWeight;
//         totalTokenWeights += _tokenWeight;
//     }
...
//         uint256 deltaBefore = tokenComposition > targetComposition
//             ? tokenComposition - targetComposition
//             : targetComposition - tokenComposition;
//         uint256 deltaAfter = compositionAfter > targetComposition
//             ? compositionAfter - targetComposition
//             : targetComposition - compositionAfter;

//         if (deltaAfter < deltaBefore) {
//             // Action moves towards target
//             uint256 fee = unwrap(ud(baseFee).mul(ud(_amount)));
//             accumulatedFees[_tokenIn] += fee;
//             return _amount - fee;
//         } else {
//             // Action moves away from target
...
//         }
//     */
//     function _calculateSwapPriceImpact(uint256 _amount, address _tokenIn, address _tokenOut)
//         internal
//         view
//         returns (uint256)
//     {
